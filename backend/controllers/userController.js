...
const paymentRazorpay = async (req,res)=>{
  try{
   ...
   // creating options for razorpay paymennt
   const options = {
...
export {registerUser,loginUser,getProfile , updateProfile,bookAppointment , listAppointment , cancelAppointment , paymentRazorpay,paymentMock} 